    ...
    <body class='bg-muted'>
        ...
        <div class="col-md-8 mx-auto bg-light text-dark text-center" >
            ...
            <?php if (isset($_SESSION['privilege']) && strtolower($_SESSION['privilege']) === "high"){ ?>
                ...
                <button type="button" class='btn btn-dark btn-lg m-4' data-toggle="modal" data-target="#NewUserForm">Create New User</button>
                <br>
                <button type="button" class='btn btn-dark btn-lg mb-5 mt-4' data-toggle="modal" data-target="#DeleteUserForm">Delete User</button>
                <br>
