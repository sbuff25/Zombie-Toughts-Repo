<?php
    ...
    function new_user_email_body($email, $first_name, $last_name, $key){
        ...
        $body .= '<a href="https://www.montanarepzombiethoughts.com/php/NewUserPassword.php?key=' . $key . '&email='. $email .'&action=setpassword" target="_blank">https://www.montanarepzombiethoughts.com/php/NewUserPassword.php?key=' . $key . '&email='. $email .'&action=setpassword</a>\n';
